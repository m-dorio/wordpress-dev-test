...
<main id="primary" class="site-main">
        ...
        <div class="container">
            <div class="about-content">
                <div class="about-image">
                    <img src="/placeholder.svg?height=400&width=600" alt="ATL Crane Trucks in action">
                </div>
        ...
        <div class="container">
            <div class="services-content">
                ...
                <div class="services-image">
                    <img src="/placeholder.svg?height=400&width=600" alt="Our crane services">
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            <div class="service-areas-content">
                <div class="service-areas-map">
                    <img src="/placeholder.svg?height=400&width=500" alt="Service areas map">
                </div>
    ...
    <section class="why-choose">
        <div class="why-choose-background">
            <img src="/placeholder.svg?height=600&width=1200" alt="Construction site background">
        </div>
        <div class="container">
        ...
        <div class="container">
            <div class="contact-content">
                <div class="contact-image">
                    <img src="/placeholder.svg?height=400&width=600" alt="ATL Crane Trucks contact">
                </div>
                <div class="contact-info">
                    ...
                    <div class="contact-details">
                        ...
                        <div class="contact-item">
                            ...
                            <span>0402 268 122</span>
                        </div>
                        <div class="contact-item">
                            <span class="contact-icon">✉️</span>
                            <span>atlcranetrucks@gmail.com</span>
                        </div>
                    </div>

                    <a href="tel:0402268122" class="btn-primary">CONTACT</a>
                </div>
            </div>
        </div>
    </section>
